                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <a class="fa fa-plus" href="tambah-data-dokter.php">Tambah Data</a>
                            </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                   <td><?php echo $key+1 ?></td>
                                                    ...
                                                    <td><?php echo $dokter['jadwal_kerja'] ?></td>    
                                                    <!-- <td><?php echo $dokter['id_playkes'] ?></td>     -->
                                                    <td>
                                                        <a href="ubah-data-dokter.php?id_dokter=<?php echo $dokter['id_dokter'] ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                                                        <a onclick="return confirm('Yakin menghapus data ini?')" href="hapus-data-dokter.php?id_dokter=<?php echo $dokter['id_dokter'] ?>" class="btn btn-danger"><span class="fa fa-trash"></span></i></a>
                                                    </td>
                                                </tr> 
                                                <?php endforeach ?>
                                            </tbody>
