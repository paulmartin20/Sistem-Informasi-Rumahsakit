<?php 
    ...
    $sql = "INSERT INTO posyandu (id_posyandu, foto, nama_posyandu, alamat, fasilitas) VALUES (:id_posyandu, :foto, :nama_posyandu, :alamat, :fasilitas)";
    
    $list_posyandu = $conn->prepare($sql);
    $list_posyandu->execute($data);
            ...
            <div class="col-md-12">
                <div class="panel panel-primary">
                    ...
                    <form action="" method="post"> 
                            ...
                            <div class="form-group">
                                <label for="" class="label-control">Nama posyandu</label>
                                <input name="nama_posyandu" type="text" class="form-control" autocomplete="off">
                            </div> 
                            <div class="form-group">
