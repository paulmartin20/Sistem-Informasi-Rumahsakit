<?php 
    ...
    $data_posyandu = $query_data_posyandu->fetchObject();
    ...
    if($_POST){
        ...
        $data['nama_posyandu'] = $_POST['nama_posyandu'];
        $data['alamat'] = $_POST['alamat'];
        $data['fasilitas'] = $_POST['fasilitas']; 

       $sql = "UPDATE posyandu SET  id_posyandu=:id_posyandu, foto=:foto, nama_posyandu=:nama_posyandu, alamat=:alamat, fasilitas=:fasilitas  where id_posyandu=:id_posyandu";
        $data_posyandu = $conn->prepare($sql);
        $data_posyandu->execute($data);
                    ...
                    <div class="panel-body">
                        <form action="" method="post">
                            <div class="form-group">
                                ...
                                <input name="id_posyandu" value="<?php echo $data_posyandu->id_posyandu ?>" type="text" class="form-control" READONLY>
                            </div>
                            <div class="form-group">
                                <label for="" class="label-control">foto</label>
                                <input name="foto" value="<?php echo $data_posyandu->foto ?>" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="" class="label-control">nama_posyandu</label>
                                <input name="nama_posyandu" value="<?php echo $data_posyandu->nama_posyandu ?>" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="" class="label-control">alamat</label>
                                <input name="alamat" value="<?php echo $data_posyandu->alamat ?>" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="" class="label-control">fasilitas</label>
                                <input name="fasilitas" value="<?php echo $data_posyandu->fasilitas ?>" type="text" class="form-control">
                            </div> 
                            <div class="form-group">
