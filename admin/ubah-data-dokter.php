<?php 
    ...
    $data_dokter = $query_data_dokter->fetchObject();
    ...
    if($_POST){
       ...
       $sql = "UPDATE dokter SET  id_dokter=:id_dokter, nama=:nama, Jenis_kelamin=:Jenis_kelamin, spesialis=:spesialis, jadwal_kerja=:jadwal_kerja  where id_dokter=:id_dokter";
        $data_dokter = $conn->prepare($sql);
        $data_dokter->execute($data);
                    ...
                    <div class="panel-body">
                        <form action="" method="post">
                            <div class="form-group">
                                ...
                                <input name="id_dokter" value="<?php echo $data_dokter->id_dokter ?>" type="text" class="form-control" READONLY>
                            </div>
                            <div class="form-group">
                                <label for="" class="label-control">nama</label>
                                <input name="nama" value="<?php echo $data_dokter->nama ?>" type="text" class="form-control">
                            </div>
                            <!-- <div class="form-group">
                                <label for="" class="label-control">Jenis_kelamin</label>
                                <input name="Jenis_kelamin" value="<?php echo $data_dokter->Jenis_kelamin ?>" type="text" class="form-control">
                            </div> -->
                            <div for="" class="label-control" aria-placeholder="jenis kelamin">jenis kelamin</label>
                                <select class="form-control" id="Jenis_kelamin" name="Jenis_kelamin" value="<?php echo $data_dokter->nama ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input name="spesialis" value="<?php echo $data_dokter->spesialis ?>" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="" class="label-control"> jadwal kerja</label>
                                <input name="jadwal_kerja" value="<?php echo $data_dokter->jadwal_kerja ?>" type="text" class="form-control">
                            </div> 
                            <div class="form-group">
