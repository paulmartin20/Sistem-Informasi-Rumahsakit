                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <a class="fa fa-plus" href="tambah-data-lokasi.php">Tambah Data</a>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <thead>
                                        ...
                                        <th>aksi</th>
                                            ...
                                            <tbody>
                                                <?php foreach($list_lokasi as $key => $lokasi) : ?>
                                                <tr>
                                                   <td><?php echo $key+1 ?></td>
                                                    ...
                                                    <td>
                                                        <a href="ubah-data-lokasi.php?id_lokasi=<?php echo $lokasi['id_lokasi'] ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                                                        <a onclick="return confirm('Yakin menghapus data ini?')" href="hapus-data-maps.php?id_lokasi=<?php echo $lokasi['id_lokasi'] ?>" class="btn btn-danger"><span class="fa fa-trash"></span></i></a>
                                                    </td>
                                                </tr> 
                                                <?php endforeach ?>
                                            </tbody>
