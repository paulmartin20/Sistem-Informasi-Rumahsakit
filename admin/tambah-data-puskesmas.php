<?php 
    ...
    $sql = "INSERT INTO puskesmas (id_puskesmas, gambar, nama_puskesmas, alamat, fasilitas) VALUES (:id_puskesmas, :gambar, :nama_puskesmas, :alamat, :fasilitas)";
    
    $list_puskesmas = $conn->prepare($sql);
    $list_puskesmas->execute($data);
                    ...
                    <form action="" method="post"> 
                            ...
                            <div class="form-group">
                                <label for="" class="label-control">gambar</label>
                                 <input name="gambar" type="text" class="form-control" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label for="" class="label-control">Nama puskesmas</label>
                                <input name="nama_puskesmas" type="text" class="form-control" autocomplete="off">
                            </div> 
                            <div class="form-group">
