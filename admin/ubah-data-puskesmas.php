<?php 
    ...
    $sql = "select * from puskesmas where id_puskesmas=:id_puskesmas";
    $query_data_puskesmas = $conn->prepare($sql);
    $query_data_puskesmas->execute($data);

    $data_puskesmas = $query_data_puskesmas->fetchObject();
    ...
    if($_POST){
        ...
        $data['nama_puskesmas'] = $_POST['nama_puskesmas'];
        $data['alamat'] = $_POST['alamat'];
        $data['fasilitas'] = $_POST['fasilitas']; 

       $sql = "UPDATE puskesmas SET  id_puskesmas=:id_puskesmas, gambar=:gambar, nama_puskesmas=:nama_puskesmas, alamat=:alamat, fasilitas=:fasilitas  where id_puskesmas=:id_puskesmas";
        $data_puskesmas = $conn->prepare($sql);
        $data_puskesmas->execute($data);
                    ...
                    <div class="panel-body">
                        <form action="" method="post">
                            <div class="form-group">
                                ...
                                <input name="id_puskesmas" value="<?php echo $data_puskesmas->id_puskesmas ?>" type="text" class="form-control" READONLY>
                            </div>
                            <div class="form-group">
                                <label for="" class="label-control">gambar</label>
                                <input name="gambar" value="<?php echo $data_puskesmas->gambar ?>" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="" class="label-control">nama_puskesmas</label>
                                <input name="nama_puskesmas" value="<?php echo $data_puskesmas->nama_puskesmas ?>" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="" class="label-control">alamat</label>
                                <input name="alamat" value="<?php echo $data_puskesmas->alamat ?>" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="" class="label-control">fasilitas</label>
                                <input name="fasilitas" value="<?php echo $data_puskesmas->fasilitas ?>" type="text" class="form-control">
                            </div> 
                            <div class="form-group">
