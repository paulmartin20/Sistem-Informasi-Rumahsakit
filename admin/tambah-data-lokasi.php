<?php 
    ...
    $sql = "INSERT INTO lokasi (id_lokasi, nama_lokasi, latitude, longitude) VALUES (:id_lokasi, :nama_lokasi, :latitude, :longitude)";
    
    $list_lokasi = $conn->prepare($sql);
    $list_lokasi->execute($data);
                      ...
                      <div class="col-md-12">
                        ...
                        <form action="" method="post"> 
                            <div class="form-group">
                                ...
                                <input name="id_lokasi" type="text" class="form-control" autocomplete="off" readonly placeholder="terisi otomatis">
                            </div>
                            <div class="form-group">
                                <label for="" class="label-control">nama_lokasi</label>
                                 <input name="nama_lokasi" type="text" class="form-control" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label for="" class="label-control">latitude</label>
                                <input name="latitude" id="latitude" type="text" class="form-control" autocomplete="off">
                            </div> 
                            <div class="form-group">
                                <label for="" class="label-control">longitude</label>
                                <input name="longitude" id="longitude" type="text" class="form-control" autocomplete="off">
                            </div> 
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="" class="label-control">id_puskesmas</label>
                                <input name="id_puskesmas" type="text" class="form-control" autocomplete="off">
                            </div> 
                            <div class="form-group">
                                <label for="" class="label-control">id_posyandu</label>
                    ...
                    <div class="row">
                      <div class="col-md-12">
                              <div class="panel panel-primary">
                                ...
                                <div id="googleMap" style="width:541px;height:600px;"></div>
                              </div>
                      </div> 
                    </div>
                  </div>
