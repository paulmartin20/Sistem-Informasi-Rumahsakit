<?php 
    ...
    $data_rumah_sakit = $query_data_rumah_sakit->fetchObject();
    ...
    if($_POST){
        ...
        $data['nama_rumah_sakit'] = $_POST['nama_rumah_sakit'];
        $data['alamat'] = $_POST['alamat'];
        $data['fasilitas'] = $_POST['fasilitas']; 

       $sql = "UPDATE rumah_sakit SET  id_rumah_sakit=:id_rumah_sakit, foto=:foto, nama_rumah_sakit=:nama_rumah_sakit, alamat=:alamat, fasilitas=:fasilitas  where id_rumah_sakit=:id_rumah_sakit";
        $data_rumah_sakit = $conn->prepare($sql);
        $data_rumah_sakit->execute($data);
                    ...
                    <div class="panel-body">
                        <form action="" method="post">
                            <div class="form-group">
                                ...
                                <input name="id_rumah_sakit" value="<?php echo $data_rumah_sakit->id_rumah_sakit ?>" type="text" class="form-control" READONLY>
                            </div>
                            <div class="form-group">
                                <label for="" class="label-control">foto</label>
                                <input name="foto" value="<?php echo $data_rumah_sakit->foto ?>" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="" class="label-control">nama_rumah_sakit</label>
                                <input name="nama_rumah_sakit" value="<?php echo $data_rumah_sakit->nama_rumah_sakit ?>" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="" class="label-control">alamat</label>
                                <input name="alamat" value="<?php echo $data_rumah_sakit->alamat ?>" type="text" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="" class="label-control">fasilitas</label>
                                <input name="fasilitas" value="<?php echo $data_rumah_sakit->fasilitas ?>" type="text" class="form-control">
                            </div> 
                            <div class="form-group">
