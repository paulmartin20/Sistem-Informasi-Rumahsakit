...
$list_puskesmas = $conn->prepare($sql);
$list_puskesmas->execute();
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            <h4>List puskesmas</h4> 
                            <div class="add-product">
                            <a class="fa fa-plus" href="tambah-data-puskesmas.php">Tambah Data</a>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <thead>
                                        ...
                                        <th>aksi</th>
                                            ...
                                            <tbody>
                                                <?php foreach($list_puskesmas as $key => $puskesmas) : ?>
                                                <tr>
                                                   <td><?php echo $key+1 ?></td>
                                                    <td><?php echo $puskesmas['id_puskesmas'] ?></td> 
                                                    <td><?php echo $puskesmas['gambar'] ?></td> 
                                                    <td><?php echo $puskesmas['nama_puskesmas'] ?></td>
                                                    <td><?php echo $puskesmas['alamat'] ?></td>
                                                    <td><?php echo $puskesmas['fasilitas'] ?></td> 
                                                    <td>
                                                        <a href="ubah-data-puskesmas.php?id_puskesmas=<?php echo $puskesmas['id_puskesmas'] ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                                                        <a onclick="return confirm('Yakin menghapus data ini?')" href="hapus-data-puskesmas.php?id_puskesmas=<?php echo $puskesmas['id_puskesmas'] ?>" class="btn btn-danger"><span class="fa fa-trash"></span></i></a>
                                                    </td>
                                                </tr> 
                                                <?php endforeach ?>
                                            </tbody>
