...
$list_rumah_sakit = $conn->prepare($sql);
$list_rumah_sakit->execute();
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            <h4>List rumah_sakit</h4> 
                            <div class="add-product">
                            <a class="fa fa-plus" href="tambah-data-rumah_sakit.php">Tambah Data</a>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <thead>
                                        ...
                                        <th>aksi</th>
                                            ...
                                            <tbody>
                                                <?php foreach($list_rumah_sakit as $key => $rumah_sakit) : ?>
                                                <tr>
                                                   <td><?php echo $key+1 ?></td>
                                                    <td><?php echo $rumah_sakit['id_rumah_sakit'] ?></td> 
                                                    <td><?php echo $rumah_sakit['foto'] ?></td> 
                                                    <td><?php echo $rumah_sakit['nama_rumah_sakit'] ?></td>
                                                    <td><?php echo $rumah_sakit['alamat'] ?></td>
                                                    <td><?php echo $rumah_sakit['fasilitas'] ?></td> 
                                                    <td>
                                                        <a href="ubah-data-rumah_sakit.php?id_rumah_sakit=<?php echo $rumah_sakit['id_rumah_sakit'] ?>" class="btn btn-warning"><i class="fa fa-pencil"></i></a>
                                                        <a onclick="return confirm('Yakin menghapus data ini?')" href="hapus-data-rumah_sakit.php?id_rumah_sakit=<?php echo $rumah_sakit['id_rumah_sakit'] ?>" class="btn btn-danger"><span class="fa fa-trash"></span></i></a>
                                                    </td>
                                                </tr> 
                                                <?php endforeach ?>
                                            </tbody>
