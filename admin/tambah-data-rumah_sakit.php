<?php 
    ...
    $sql = "INSERT INTO rumah_sakit (id_rumah_sakit, foto, Nama_rumah_sakit, alamat, fasilitas) VALUES (:id_rumah_sakit, :foto, :Nama_rumah_sakit, :alamat, :fasilitas)";
    
    $list_rumah_sakit = $conn->prepare($sql);
    $list_rumah_sakit->execute($data);
                    ...
                    <form action="" method="post"> 
                            ...
                            <div class="form-group">
                                <label for="" class="label-control">foto</label>
                                 <input name="foto" type="text" class="form-control" autocomplete="off">
                            </div>
                            <div class="form-group">
                                <label for="" class="label-control">Nama rumah sakit</label>
                                <input name="Nama_rumah_sakit" type="text" class="form-control" autocomplete="off">
                            </div> 
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input name="fasilitas" type="text" class="form-control" autocomplete="off">
                            </div> 
                            <div class="form-group">
